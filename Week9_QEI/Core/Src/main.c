...
//	  QEIReadRaw = __HAL_TIM_GET_COUNTER(&htim3);
//
//	  theta = (QEIReadRaw/3072.0)*360.0;
//
//	  QEI_Read.Current = QEIReadRaw;
//	  if(QEI_Read.Current - QEI_Read.Last >  2000)
//	  {
//		  count++;
//	  }
//	  QEI_Read.Last = QEI_Read.Current;
  }
  /* USER CODE END 3 */
}
