...
void Position_Control()
{
	e = Setpoint.Position - Measure.Position;
	...
	else e_Integral += e*dt;

	e_Derivative = Setpoint.Velocity - Measure.Velocity;

	duty_raw = Kp*e + Ki*e_Integral + Kd*e_Derivative;
